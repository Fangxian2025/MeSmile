...
function validPayload(overrides = {}) {
  ...
  return {
    ...
    aud: "mesmile-oidc-proxy",
    iat: now - 10,
    exp: now + 300,
    jti: `test-jti-${++jtiCounter}`,
    repository: "Fangxian2025/MeSmile",
    ref: "refs/heads/main",
    sub: "repo:Fangxian2025/MeSmile:ref:refs/heads/main",
    ...overrides,
  };
}
