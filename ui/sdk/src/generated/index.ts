...
export const GOOSE_EXT_METHODS = [
  ...
  {
    method: "_mesmile/unstable/dictation/models/download",
  ...
  {
    method: "_mesmile/unstable/dictation/models/cancel",
    requestType: "DictationModelCancelRequest_unstable",
    responseType: "EmptyResponse",
  },
  {
    method: "_mesmile/unstable/dictation/models/delete",
    requestType: "DictationModelDeleteRequest_unstable",
    responseType: "EmptyResponse",
  },
  {
    method: "_mesmile/unstable/dictation/models/select",
...
export const GOOSE_EXT_NOTIFICATIONS = [
  {
    method: "_mesmile/unstable/session/update",
