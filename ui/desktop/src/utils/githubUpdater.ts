...
export class GitHubUpdater {
  ...
  private readonly repo = process.env.GITHUB_REPO || 'MeSmile'';
  ...
  async checkForUpdates(): Promise<UpdateCheckResult> {
    ...
    try {
      ...
      const asset = release.assets.find((a) => a.name.toLowerCase() === assetName.toLowerCase()); // keeping comparison to lowercase because MeSmile vs mesmile
      if (asset) {
