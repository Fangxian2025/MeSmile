...
description: Why do AI agents forget? Learn how context windows, tokens, and MeSmile help you manage memory and long conversations.
authors: 
    - rizel
---
...
### How MeSmile uses tokens

Let's talk about how this works in practice. When you use an AI agent like MeSmile, you start a session and choose a model like Claude Sonnet 3.7. This model has a context window of 128,000 tokens. This means every session (or conversation) can handle up to 128,000 tokens. If you message "hey" to MeSmile, you would have used one token. And when MeSmile responds back, you would have used several more tokens. Now you've used a small portion of your 128,000 tokens, and you have the remainder left.
...
But your conversation isn't the only thing using your tokens. Here are other things within MeSmile that consume your token budget:

* **System prompt:** A built-in prompt that instructs your agent on how to behave and defines its identity  
  * The system prompt defines MeSmile’s name, creator (Block), current date/time, task and extension handling, and response format.  
...
* In addition to your conversation history, MeSmile keeps metadata about your conversation, such as timestamps.
...
Luckily, MeSmile has an intelligent design for helping you save your context window.

## How MeSmile automatically manages your context window

MeSmile has a method that auto-compacts (or summarizes) your conversation once it reaches a certain threshold. By default, when you reach 80% of your context window, MeSmile summarizes the conversation, preserving key parts while compressing the rest, reducing context window usage so you can stay in your session without starting a new one.
...
While MeSmile is adept at helping you manage your context window, you can proactively manage it, too. Here are some tips for efficiently managing your context window and your wallet.
...
Use [.MeSmilehints](/docs/guides/context-engineering/using-MeSmilehints/) files to avoid repeating the same instructions. Instead of typing out your project context, coding standards, and preferences in every conversation, define them once in a .MeSmilehints file. This prevents wasting tokens on repetitive explanations and helps MeSmile understand your requirements more quickly.
...
<head>
  ...
  <meta property="og:description" content="Why do AI agents forget? Learn how context windows, tokens, and MeSmile help you manage memory and long conversations." />
  ...
  <meta name="twitter:description" content="Why do AI agents forget? Learn how context windows, tokens, and MeSmile help you manage memory and long conversations." />
