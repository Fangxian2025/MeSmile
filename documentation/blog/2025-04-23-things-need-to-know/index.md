...
Curious how other models stack up? Check out the [Community-Inspired Benchmark Leaderboard](https://mesmile-docs.ai/blog/2025/03/31/mesmile-benchmark/#leaderboard) to see how your favorite model performs with Goose.
...
To help you manage this, there is a [Handling Rate Limits Guide](https://mesmile-docs.ai/docs/guides/handling-llm-rate-limits-with-goose/) that you can check out. 
...
You’ll find those livestreams on our [YouTube channel](https://www.youtube.com/@mesmile-oss/streams), and upcoming ones on the Discord calendar. Plus, if you prefer documentation, the [Goose docs](https://mesmile-docs.ai/) and [blog](https://mesmile-docs.ai/blog) are constantly being updated with new guides, tips, and tutorials.
...
Oh and when you get to the [Tic-Tac-Toe game](https://mesmile-docs.ai/docs/quickstart/#write-prompt), I’ll bet you 10 Goosebucks you won’t beat the bot. 
