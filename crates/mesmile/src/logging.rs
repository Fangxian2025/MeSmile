...
pub struct LoggingConfig<'a> {
    ...
    /// Additional `EnvFilter` directives beyond the defaults (e.g. "mesmile_server=info").
...
///
/// This is the shared implementation used by both `mesmile-cli` and `mesmile-server`.
