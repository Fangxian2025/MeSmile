...
test.describe('Enhanced Context Management E2E Tests', () => {
  ...
  test.describe('Context Window Alert System', () => {
    test('should show context window alert only when tokens are being used', async ({ mesmilePage }) => {
    ...
    test('should update progress bar as conversation grows', async ({ mesmilePage }) => {
      const chatInput = mesmilePage.locator('[data-testid="chat-input"]');
      ...
      const progressText1 = await mesmilePage.locator('[role="alert"]').textContent();
      ...
      await mesmilePage.keyboard.press('Escape');
      ...
      const progressText2 = await mesmilePage.locator('[role="alert"]').textContent();
  ...
  test.describe('Manual Compaction Workflow', () => {
    test('should perform complete manual compaction workflow', async ({ mesmilePage }) => {
      const chatInput = mesmilePage.locator('[data-testid="chat-input"]');
    ...
    test('should hide alert indicator after successful compaction', async ({ mesmilePage }) => {
      const chatInput = mesmilePage.locator('[data-testid="chat-input"]');
      ...
      if (isVisible) {
        ...
        const alertContent = await mesmilePage.locator('[role="alert"]').textContent();
    ...
    test('should prevent multiple simultaneous compaction attempts', async ({ mesmilePage }) => {
      const chatInput = mesmilePage.locator('[data-testid="chat-input"]');
  ...
  test.describe('Post-Compaction Behavior', () => {
    test('should allow scrolling to view ancestor messages after compaction', async ({ mesmilePage }) => {
      const chatInput = mesmilePage.locator('[data-testid="chat-input"]');
      ...
      for (let i = 0; i < 10; i++) {
        ...
        await mesmilePage.waitForTimeout(100);
      }
      
      // Check if we can find at least one of our original messages
      const hasFirstMessage = await mesmilePage.locator('text=FIRST_UNIQUE_MESSAGE').isVisible();
      const hasSecondMessage = await mesmilePage.locator('text=SECOND_UNIQUE_MESSAGE').isVisible();
      const hasThirdMessage = await mesmilePage.locator('text=THIRD_UNIQUE_MESSAGE').isVisible();
    ...
    test('should continue conversation normally after compaction', async ({ mesmilePage }) => {
      const chatInput = mesmilePage.locator('[data-testid="chat-input"]');
      ...
      await expect(mesmilePage.locator('text=POST_COMPACTION_MESSAGE')).toBeVisible();
    ...
    test('should maintain proper message ordering after compaction', async ({ mesmilePage }) => {
      const chatInput = mesmilePage.locator('[data-testid="chat-input"]');
      ...
      const allMessages = mesmilePage.locator('[data-testid="message"]');
  ...
  test.describe('Error Handling', () => {
    ...
    test('should handle network timeouts during compaction', async ({ mesmilePage }) => {
      // Mock a timeout
      await mesmilePage.route('**/api/sessions/*/manage-context', async (route) => {
      ...
      await mesmilePage.waitForSelector('[data-testid="loading-mesmile"]', { state: 'hidden', timeout: 35000 });
  ...
  test.describe('UI State Management', () => {
    test('should disable chat input during compaction', async ({ mesmilePage }) => {
      const chatInput = mesmilePage.locator('[data-testid="chat-input"]');
    ...
    test('should show appropriate loading states', async ({ mesmilePage }) => {
      const chatInput = mesmilePage.locator('[data-testid="chat-input"]');
      ...
      const regularLoadingMessages = mesmilePage.locator('[data-testid="loading-mesmile"]:not(:has-text("compacting"))');
  ...
  test.describe('Performance and Reliability', () => {
    test('should handle large conversations efficiently', async ({ mesmilePage }) => {
      const chatInput = mesmilePage.locator('[data-testid="chat-input"]');
      ...
      for (const message of messages) {
        ...
        await mesmilePage.keyboard.press('Enter');
        await mesmilePage.waitForSelector('[data-testid="loading-mesmile"]', { state: 'hidden', timeout: 30000 });
        await mesmilePage.waitForTimeout(500);
      }
      ...
      await mesmilePage.waitForSelector('[data-testid="loading-mesmile"]', { state: 'hidden', timeout: 45000 });
    ...
    test('should maintain conversation context after compaction', async ({ mesmilePage }) => {
      const chatInput = mesmilePage.locator('[data-testid="chat-input"]');
