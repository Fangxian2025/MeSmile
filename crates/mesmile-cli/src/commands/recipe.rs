...
"#;
    ...
    fn test_handle_deeplink_valid_recipe() {
        ...
        assert!(url.starts_with("mesmile://recipe?config="));
        let encoded_part = url.strip_prefix("mesmile://recipe?config=").unwrap();
