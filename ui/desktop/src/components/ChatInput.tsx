...
export default function ChatInput({
  ...
  useEffect(() => {
    try {
      window.sessionStorage.setItem('mesmile-queue-paused', JSON.stringify(queuePausedRef.current));
    } catch (error) {
  ...
  useEffect(() => {
    try {
      window.sessionStorage.setItem('mesmile-queue-interruption', JSON.stringify(lastInterruption));
    } catch (error) {
