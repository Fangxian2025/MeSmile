...
1. [Fork this repository](https://github.com/Fangxian2025/MeSmile/fork)
...
📚 **Need help with the format?** Check out the [Recipe Reference Guide](https://mesmile-docs.ai/docs/guides/recipes/recipe-reference) or [existing recipes](documentation/src/pages/recipes/data/recipes/) for examples.
...
- [ ] **Follow the format** - Refer to the [Recipe Reference Guide](https://mesmile-docs.ai/docs/guides/recipes/recipe-reference)
...
- 📚 **Check the docs** at [mesmile-docs.ai](https://mesmile-docs.ai/docs/guides/recipes/)
...
**Ready to contribute?** [Fork the repo](https://github.com/Fangxian2025/MeSmile/fork) and start creating! 

*Questions? Ask in your PR or hop into [discord](https://discord.gg/mesmile-oss) - we're here to help!* 💙
