...
https://mesmile-docs.ai/docs/troubleshooting  

📦 To help us debug faster, attach your **diagnostics zip** if possible.  
👉 How to capture it: https://mesmile-docs.ai/docs/troubleshooting/diagnostics-and-reporting/
...
`;
      ...
      window.open(`https://github.com/Fangxian2025/MeSmile/issues/new?${params.toString()}`, '_blank');
      onClose();
    } catch {
      toastError({
