...
const WindowsDesktopInstallButtons = () => {
  return (
    <div>
      <p>Click one of the buttons below to download MeSmile Desktop for Windows:</p>
      <div className="pill-button" style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
        <Link
          className="button button--primary button--lg"
          to="https://github.com/Fangxian2025/MeSmile/releases/download/stable/Goose-win32-x64.zip"
        >
