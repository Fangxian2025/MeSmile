...
mod tests {
    ...
    #[test]
    fn stdio_config_converts_to_mesmile_mcp_extension_without_literal_envs() {
    ...
    #[test]
    fn streamable_http_config_converts_to_mesmile_mcp_extension_without_literal_envs() {
