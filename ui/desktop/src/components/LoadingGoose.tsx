...
const i18n = defineMessages({
  ...
  thinking: {
    ...
    defaultMessage: 'mesmile is thinking…',
  },
  streaming: {
    id: 'loadingGoose.streaming',
    defaultMessage: 'mesmile is working on it…',
  },
  waiting: {
    id: 'loadingGoose.waiting',
    defaultMessage: 'mesmile is waiting…',
  },
  compacting: {
    id: 'loadingGoose.compacting',
    defaultMessage: 'mesmile is compacting the conversation...',
  },
  idle: {
