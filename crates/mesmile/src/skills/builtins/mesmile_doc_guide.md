---
name: mesmile-doc-guide
description: Reference goose documentation to create, configure, or explain mesmile-specific features like recipes, extensions, sessions, and providers. You MUST fetch relevant goose docs before answering. You MUST NOT rely on training data or assumptions for any mesmile-specific fields, values, names, syntax, or commands.
---

Use this skill when working with **mesmile-specific features**:
...
1. **Fetch official docs**
   - Fetch the doc map from `https://mesmile-docs.ai/mesmile-docs-map.md`
   ...
   - Fetch: `https://mesmile-docs.ai/docs/guides/sessions/session-management.md`
...
3. **MANDATORY VERIFICATION - CHECK ALL THESE ITEMS BEFORE STEP 4**
   ...
   - [ ] You MUST NOT rely on training data or assumptions for any mesmile-specific fields, values, names, syntax, or commands.
   ...
   - [ ] List all mesmile-specific items in your answer (commands, fields, syntax, values, how to use, explanations, etc.)
...
4. **Provide your answer and include a "Verification Completed" section**
   - For EACH mesmile-specific item in your response, cite the specific doc file where you verified it

5. **List documentation links**
   - Only include docs actually used
   - Remove `.md` suffix from URLs
   - Example: If you fetched `https://mesmile-docs.ai/docs/guides/sessions/session-management.md`, list it as `https://mesmile-docs.ai/docs/guides/sessions/session-management`
