...
```bash
# Python example
mesmile run --with-extension "python server.py" --text "EXAMPLE PROMPT HERE"

# TypeScript example
mesmile run --with-extension "node server.js" --text "EXAMPLE PROMPT HERE"

# Kotlin example
mesmile run --with-extension "java -jar build/libs/extension.jar" --text "EXAMPLE PROMPT HERE"
```
