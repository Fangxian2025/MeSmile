...
To begin, you will need to modify the [`Dockerfile` and `docker-compose.yml` files](https://github.com/Fangxian2025/MeSmile/tree/main/documentation/docs/docker) to suit your requirements. Some changes you might consider include:
...
```bash
docker-compose -f documentation/docs/docker/docker-compose.yml run --rm mesmile-cli
```
...
mesmile run --container my-dev-container --text "your instructions here"
