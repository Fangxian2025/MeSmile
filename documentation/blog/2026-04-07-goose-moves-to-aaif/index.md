...
```bash
git remote set-url origin git@github.com:Fangxian2025/MeSmile.git
```

## Migration in progress

We're still working through some migration issues (broken links, redirects, CI, etc). If you hit anything that seems off, please reach out on [Discord](https://discord.gg/mesmile-oss) and let us know.
## Learn more
