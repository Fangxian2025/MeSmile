...
fn print_editor_help() {
  ...
  Configure editor: goose configure set mesmile_prompt_editor \"vim\"
  ...
  To use inline prompts with on-demand /edit: goose configure set mesmile_prompt_editor_always false"
    );
}
