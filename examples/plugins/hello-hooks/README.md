...
A tiny [Open Plugins](https://open-plugins.com) plugin that demonstrates MeSmile's
...
MeSmile discovers plugins under `~/.agents/plugins/<name>/` (user scope) and
...
# Then run MeSmile normally; you should see lines like
...
# Inspect the full payloads MeSmile passed to the hook:
