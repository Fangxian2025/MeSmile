...
The Fetch extension [does not work](https://github.com/Fangxian2025/MeSmile/issues/1184) with Google models (e.g. gemini-2.0-flash) because this extension uses `format: uri` in its JSON schema which Google doesn't support.
:::
...
<Tabs groupId="interface">
  ...
  [Launch the installer](mesmile://extension?cmd=uvx&arg=mcp-server-fetch&id=fetch&name=Fetch&description=Web%20content%20fetching%20and%20processing%20capabilities)
  </TabItem>
